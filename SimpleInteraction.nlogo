...
;;; A model for simple communication between two agents.

breed [managers manager]
breed [persons person]


persons-own [dtask money intentions beliefs incoming-queue total-beers-delivered]
managers-own [dtask intentions beliefs incoming-queue]
